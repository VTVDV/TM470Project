...
CREATE TABLE `webpos`.`tbl_test` (
  `TEST_ID` INT NOT NULL AUTO_INCREMENT,
  `TEST_DATETIME` DATETIME NOT NULL,
  `TEST_BOOKER_ID` INT NOT NULL,
  `TEST_TESTER_ID` INT NULL,
  `TEST_STOCKRECORD_ID` INT NOT NULL,
  `TEST_SERIAL` VARCHAR(100) NULL,
  `TEST_STATUS` INT NULL,
  PRIMARY KEY (`TEST_ID`),
  UNIQUE INDEX `idtbl_test_UNIQUE` (`TEST_ID` ASC));